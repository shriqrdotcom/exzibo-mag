...
//
// Authorization is enforced on EVERY endpoint.  No DISABLE_AUTH bypass is
// applied to the superadmin rule — superadmin access comes from the email
// allow-list in SUPERADMIN_ALLOWED_EMAILS via checkRestaurantAccess.
//
// Team mutation rules:

...
import { LayoutDashboard, Settings, Zap, Users, Table2, ShieldCheck, Bell, Info, Trash2, Play, ImageDown, Route, ShieldPlus, Clock, Radio, X } from 'lucide-react'
    ...
    <>
      ...
      >
        ...
        <nav style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: '6px' }}>
          ...
          {/* DEMO nav item */}
          <button
            onClick={() => handleNavigate('/dashboard?section=demo')}
            style={{
              display: 'flex',
              alignItems: 'center',
              gap: '12px',
          ...
          <button
            onClick={() => handleNavigate('/dashboard?section=image-compressor')}
            style={{
              display: 'flex',
              alignItems: 'center',
              gap: '12px',
          ...
          {(() => {
            ...
            return (
              <button
                onClick={() => handleNavigate('/deleted-restaurants')}
                style={{
                  display: 'flex',
                  alignItems: 'center',
                  gap: '12px',
          ...
          {(() => {
            ...
            return (
              <button
                onClick={() => handleNavigate('/dynamic-route')}
                style={{
                  display: 'flex',
                  alignItems: 'center',
                  gap: '12px',
          ...
          {(() => {
            ...
            return (
              <button
                onClick={() => handleNavigate('/order-time')}
                style={{
                  display: 'flex',
                  alignItems: 'center',
                  gap: '12px',
